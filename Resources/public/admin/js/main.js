...
! function ($) {
    ...
    $(function () {
        ...
        if ($.isFunction($.fn.selectpicker)) {
            $("select").not('.notbootstrapselect').selectpicker();
        }
        ...
        $(document).on("click", ".panel-remove", function (e) {
            ...
            $(this).closest(".panel").addClass("animated fadeOutRight").attr("id", "obsolete");
            setTimeout(function () {
                $("#obsolete").remove();
            }, 600);
        });
...
{
  return confirm('¿Esta seguro de querer eliminar el elemento?');
}